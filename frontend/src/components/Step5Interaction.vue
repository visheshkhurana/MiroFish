            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">in{{ section.title }}...</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'andMedium ' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Report GenerationAgent Version，Acceptable 4 Tool，Predict </div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">AlignDataandStatus，Global/Local Memory， Analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Based on Algorithm，Event，Info </div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Based on GraphRAG  API，Optimize， NodePropertyand</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">，andMedium ， ViewpointDataandStatus</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'and Report Agent ， ReportContent' : 'and ， he Viewpoint' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="InputYouMedium Question..."
                rows="3"
              ></textarea>
            </div>
...
const sendToReportAgent = async (message) => {
  addLog(` Report Agent Send: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    chatHistory.value.push({
      role: 'assistant',
      content: res.data.response || res.data.answer || 'Response',
      timestamp: new Date().toISOString()
    })
    addLog('Report Agent alreadyReply')
  } else {
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('PleaseSelect  ')
  }
  
  addLog(` ${selectedAgent.value.username} Send: ${message.substring(0, 50)}...`)
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? '' : 'you'}：${msg.content}`)
      .join('\n')
    prompt = `YesI ：\n${historyContext}\n\ninI QuestionYes：${message}`
  }
  ...
  if (res.success && res.data) {
    //  Data: res.data.result.results Yes 
    // : {"twitter_0": {...}, "reddit_0": {...}} or {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // is，Excellent reddit  Reply
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Excellent reddit Reply， twitter
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} alreadyReply`)
    } else {
...
const submitSurvey = async () => {
  ...
  addLog(`Send ${selectedAgents.value.size}  ...`)
    ...
    if (res.success && res.data) {
      ...
      for (const interview of interviews) {
        ...
        if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
          ...
          if (agentResult) {
            responseContent = agentResult.response || agentResult.answer || 'Response'
          }
        } else if (Array.isArray(resultsDict)) {
          // 
          const matchedResult = resultsDict.find(r => r.agent_id === agentIdx)
          if (matchedResult) {
            responseContent = matchedResult.response || matchedResult.answer || 'Response'
          }
        }
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Load  ${profiles.value.length}   `)
    }
  } catch (err) {
...
/* Left Panel - Report Style (and Step4Report.vue ) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
