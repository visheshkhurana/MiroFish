    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="currentPhase === 0" class="badge processing">Generate</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLMAnalysisDocumentContentSimulation，Extract，AutoGenerate
          </p>

          <!-- Loading / Progress -->
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            <div class="spinner-sm"></div>
            <span>{{ ontologyProgress.message || 'CurrentlyAnalysisDocument...' }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Generate，DocumentAuto Zep BuildKnowledge Graph，Extracting entitiesRelationship，CommunitySummary
          </p>
          ...
          <div class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">EntityNode</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">BuildComplete</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph BuildingComplete，EnterNext StepSimulationEnvironment Setup</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Create...' : 'EnterEnvironment Setup ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// EnterEnvironment Setup - Create simulation 
const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('ProjectGraphInfo')
    return
  }
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      alert('CreateSimulationFailed: ' + (res.error || 'UnknownError'))
    }
  } catch (err) {
    console.error('CreateSimulationException:', err)
    alert('CreateSimulationException: ' + err.message)
  } finally {
