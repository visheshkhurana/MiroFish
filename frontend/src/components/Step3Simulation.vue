          ...
          >
            ...
            <div class="timeline-card">
              ...
              <div class="card-body">
                ...
                <!-- ：UnknownTypeor content notProcess -->
...
const props = defineProps({
  simulationId: String,
  maxRounds: Number, // Step2 Maximum
  minutesPerRound: {
    type: Number,
    default: 30 // Default30
  },
  projectData: Object,
  graphData: Object,
  systemLogs: Array
...
const phase = ref(0) // 0: notStart, 1: RunMedium, 2: alreadyComplete
...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // YesNoalreadyComplete（Through runner_status orCompleteStatus）
      const isCompleted = data.runner_status === 'completed' || data.runner_status === 'stopped'
      
      // ：IfBackendUpdate runner_status，alreadyReportComplete
      // Through twitter_completed and reddit_completed Status
    ...
    console.warn('RunStatusFailed:', err)
  }
}

// Enable YesNoalreadyComplete
const checkPlatformsCompleted = (data) => {
  ...
  // If Complete ，YesNoEnable Complete 
  // Through actions_count YesNoEnable（If count > 0 or running is true）
...
const handleNextStep = async () => {
  ...
  if (isGeneratingReport.value) {
    addLog('Report GenerationRequestalreadySend，Please...')
    return
  }
